          ...
          <div className="relative z-10 space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl font-black leading-[1.05] tracking-tight text-foreground">
                Bridge Your <span className="bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent italic">Skill Gaps</span>.
              </h1>
              <p className="max-w-md text-lg text-muted-foreground/80 font-medium leading-relaxed">
                Join thousands of professionals using AI to identify exactly what they need to learn next.
              </p>
            </div>
            
            <div className="space-y-4">
              {[
                { icon: Brain, text: "Smart Skill Extraction", color: "text-primary" },
                { icon: Target, text: "Personalized Roadmap", color: "text-accent" },
                { icon: Shield, text: "Verified Career Growth", color: "text-green-500" }
              ].map((item, i) => (
                <div key={i} className="flex items-center gap-3 group/item">
                  <div className={`p-2 rounded-lg bg-background/50 border border-border/50 ${item.color} group-hover/item:scale-110 transition-transform`}>
          ...
          <div className="mx-auto w-full max-w-sm space-y-10">
            ...
            <form className="space-y-7" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="flex items-start space-x-3 ml-1">
                <Checkbox id="terms" className="mt-0.5 rounded-md border-border/60 data-[state=checked]:bg-primary data-[state=checked]:border-primary" />
                <label htmlFor="terms" className="text-xs font-bold text-muted-foreground leading-tight">
                  Agree to <Link to="#" className="text-primary hover:underline">Terms of Service</Link> and <Link to="#" className="text-primary hover:underline">Privacy Policy</Link>
                </label>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" className="h-12 rounded-2xl border-border/60 hover:border-primary/40 hover:bg-primary/5 hover:text-primary font-bold transition-all duration-300 group/btn">
            ...
            <p className="text-center text-[15px] font-medium text-muted-foreground/80">
              ...
              <Link to="/signin" className="font-extrabold text-primary hover:underline underline-offset-4 decoration-2 decoration-primary/30">
                Log In
              </Link>
            </p>
          </div>
