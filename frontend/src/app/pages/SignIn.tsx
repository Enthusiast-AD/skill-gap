          ...
          <div className="relative z-10 space-y-8">
            <div className="space-y-4">
              <h1 className="text-5xl font-black leading-[1.05] tracking-tight text-foreground">
                Master Your <span className="bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent italic">Career Path</span>.
              </h1>
              <p className="max-w-md text-lg text-muted-foreground/80 font-medium leading-relaxed">
                Log in to resume your skill-gap analysis and personalized roadmap towards your dream role.
              </p>
            </div>
            ...
            <div className="flex items-center gap-6">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="h-10 w-10 shrink-0 rounded-full border-2 border-background bg-gradient-to-br from-muted-foreground/10 to-muted-foreground/20 backdrop-blur-sm" />
                ))}
              </div>
              <div className="flex flex-col">
                <span className="text-sm font-bold text-foreground">10,000+ Students</span>
                <span className="text-xs font-semibold text-muted-foreground">Joined PrepGrap AI</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex w-full flex-col justify-center p-8 sm:p-14 lg:w-1/2 bg-background/20 backdrop-blur-sm">
          <div className="mx-auto w-full max-w-sm space-y-10">
              ...
              <div className="space-y-5">
                ...
                <div className="space-y-2 group">
                  <div className="flex items-center justify-between ml-1 leading-none">
                    ...
                    <Link to="#" className="text-xs font-bold text-primary/80 hover:text-primary transition-colors">
                      Forgot?
                    </Link>
                  </div>
                  <div className="relative">
            ...
            <p className="text-center text-[15px] font-medium text-muted-foreground/80">
              Not a member?{' '}
              <Link to="/signup" className="font-extrabold text-primary hover:underline underline-offset-4 decoration-2 decoration-primary/30">
                Join PrepGrap
              </Link>
            </p>
          </div>
